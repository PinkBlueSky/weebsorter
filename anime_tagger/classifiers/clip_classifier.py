...
_LABEL_PROMPTS: dict[str, list[str]] = {
    "anime_art": [
        ...
        "a 2D illustrated anime character, not a real person or cosplayer",
    ],
    "cosplay": [
        "a real photograph of a person wearing an anime or video game costume",
        "cosplay photography of a real human being dressed as a fictional character",
        "a real person in costume at a convention or studio shoot dressed as an anime character",
        "a photograph of someone cosplaying a Japanese anime, manga, or game character",
        "a real cosplayer in a styled setting wearing an accurate fictional character costume",
        "a real human being wearing a wig and costume to portray an anime or game character",
    ],
    "real_face": [
        "a real photograph of a human face or person",
        "a photograph or selfie of a real human being, not an illustration or drawing",
        "a portrait or candid photo of a real person not wearing a fictional costume",
        "Japanese gravure idol or fashion photography of a real human being",
        "a professional photography studio shoot of a real person in lingerie or swimwear",
        "a real photograph of a person even if the image has text overlays or emoji stickers",
        "a real photo of a person in a styled interior setting with furniture and props",
        "a real human being photographed indoors with dramatic or coloured lighting",
        "a full body photograph of a real person in a styled indoor setting",
    ],
    "landscape": [
    ...
    "other": [
        "a photograph of an animal, pet, or wildlife with no people",
